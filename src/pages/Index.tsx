          ...
          <div className="flex space-x-1 sm:space-x-4 overflow-x-auto py-2">
            <button
              ...
              className={`flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 ${
                currentTab<dyad-write path="src/pages/Index.tsx" description="Complete Index page with About Us tab integrated seamlessly">
import React, { useState, useMemo } from 'react';
import { LmsProvider, useLms } from '../context/LmsContext';
import { Navbar } from '../components/layout/Navbar';
import { CourseCard } from '../components/course/CourseCard';
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="flex items-center gap-3">
                ...
                <Select value={selectedLevel} onValueChange={setSelectedLevel}>
                  <SelectTrigger className="w-36 h-9 rounded-<dyad-write path="src/pages/Index.tsx" description="Complete Index page with About Us tab integrated seamlessly">
import React, { useState, useMemo } from 'react';
import { LmsProvider, useLms } from '../context/LmsContext';
import { Navbar } from '../components/layout/Navbar';
import { CourseCard } from '../components/course/CourseCard';
